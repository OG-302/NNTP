...
public class Specification {
    ...
    public enum NNTP_Request_Commands {
         ...
         * NB. The algorithm chooses the Command whose value is the longest match (i.e. word length, where words are
         * text surrounded by whitespace). e.g., LIST.ACTIVE.TIME will be returned over LIST ACTIVE.
         */
    ...
    public enum NNTP_Response_Code {
        ...
        Code_101(101), // Generated by: CAPABILITIES.  Meaning: the capabilities list follows.
    ...
    public enum NNTP_Standard_Article_Headers {
        ...
        NNTP_Standard_Article_Headers(String value) {
            // the internal value is normalized to lowercase to support case-insensitive comparisons.
        ...
        /**
         * Returns true if the header is mandatory for every article.
         * Only Bytes, Lines, and References are not mandatory.  The rest are mandatory.
         */
    ...
    /**
     * A newsgroup is an entity defined by the RFC to contain Articles.
     * Newsgroups are identified by a NewsgroupName.  The NewsgroupName is a valid NNTP newsgroup name, and is
     * immutable.  The Description is a human-readable description of the Newsgroup, and is mutable. The PostingMode
     * determines whether the Newsgroup should accept new Articles, whether that is prohibited, or
     * whether this action is moderated.  The PostingMode is mutable.  The createdBy field is a human-readable string
     * intended for identifying the person who created the Newsgroup.  The createdAt field is the localtime the
     * Newsgroup was created.
     * Articles are submitted for inclusion into Newsgroups via the POST and IHAVE commands, and also in this
     * implementation via the NewsgroupSynchronizer's syncNewsgroup() method.
     * As an Article may contain several Newsgroups in its Newsgroups header, so the same Article may appear in several
     * Newsgroups.
     * See subtypes of this class defined in the PersistenceService for more information and nuance.
     */
    public abstract static class Newsgroup {
        ...
        protected Newsgroup(NewsgroupName name, String description, PostingMode postingMode, String createdBy) {
            if (name == null) {
                throw new IllegalArgumentException("Newsgroup name cannot be null");
            }
            this.name = name;
        ...
        void  setDescription(String description) {
            if (description == null) {
                ...
                // only allow alphanumeric and space characters in the description string.
        ...
        void setCreatedBy(String createdBy) {
            if (createdBy == null) {
                ...
                this.createdBy = createdBy.replaceAll("[^a-zA-Z0-9@. ]", "");
            }
        }
        ...
        /**
         * Metrics pertaining only to Articles with assigned ArticleNumbers in a newsgroup.
         * (PendingArticles do not have ArticleNumbers assigned to them, and so do not appear in the metrics.)
         */
